export const translations = {
  en: {
    ...
    directContact: "For direct licensing communication:",
    ...
    step1Desc:
      "Thorough verification of content rights, territories, and licensing windows to ensure full compliance.",
    ...
    step3Desc:
      "Strategic placement, metadata optimization, and audience targeting across YouTube AVOD channels.",
...
"Exhibition is carried out through AVOD channels on YouTube optimized for genre film audiences. Our strategy combines metadata optimization, content positioning, and performance analytics to maximize reach and monetization.",
    ...
    // DISTRIBUTOR STRIP
    distributorTitle: "For Distributors & Rights Holders",
    distributorDesc:
  ...
  es: {
    ...
    // CONTACT extras
    complianceNote:
      "Todas las consultas se revisan bajo nuestras directrices de cumplimiento de derechos.",
    directContact: "Para comunicación directa de licencias:",
    ...
    step1Desc:
      "Verificación exhaustiva de derechos de contenido, territorios y ventanas de licencia para garantizar pleno cumplimiento.",
    ...
    step3Desc:
      "Ubicación estratégica, optimización de metadatos y segmentación de audiencia en canales AVOD de YouTube.",
...
"La exhibición se realiza a través de canales AVOD en YouTube optimizados para audiencias de cine de género. Nuestra estrategia combina optimización de metadatos, posicionamiento de contenido y análisis de rendimiento para maximizar el alcance y la monetización.",
    ...
    // DISTRIBUTOR STRIP
    distributorTitle: "Para Distribuidores y Titulares de Derechos",
    distributorDesc:
